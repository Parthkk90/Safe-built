...
import { idlFactory } from './BlockHero_frontend.did.js';
export { idlFactory } from './BlockHero_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BLOCKHERO_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./BlockHero_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the BlockHero_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./BlockHero_frontend.did.js")._SERVICE>}
 */
export const BlockHero_frontend = createActor(canisterId);
