...
export const canisterId = process.env.CANISTER_ID_BLOCKHERO_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./BlockHero_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the BlockHero_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./BlockHero_backend.did.js")._SERVICE>}
 */
export const BlockHero_backend = createActor(canisterId);
